  ...
  return (
    ...
    >
      ...
      <a href="Harinipriya_resume.pdf" download={true} target="_blank">
        <button className="my-2 rounded-md bg-purple-400 px-4 py-2 font-semibold transition-transform duration-300 hover:scale-x-105 hover:bg-purple-500 dark:bg-gray-500 dark:hover:bg-gray-600">
          Resume
        </button>
      </a>
    </div>
